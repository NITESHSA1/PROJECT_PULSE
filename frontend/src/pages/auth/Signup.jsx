  ...
  return (
    <div className="relative flex min-h-screen items-center justify-center overflow-hidden bg-ink-950 px-4">
      ...
      <div className="relative w-full max-w-sm">
        ...
        <h1 className="mb-1 font-display text-2xl font-semibold text-slate-100">Create your account</h1>
        <p className="mb-6 text-sm text-slate-400">Free to use � no credit card needed.</p>
        ...
        <form onSubmit={handleSubmit} className="glass space-y-4 rounded-lg border border-ink-700 p-6">
          ...
          <Input
            ...
            placeholder="Enter your Email here ✉︎"
          />
          <Input
            label="Password"
            type="password"
            ...
            placeholder="Enter your Password <6 letters 🔐"
          />
